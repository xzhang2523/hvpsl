...
def grad_multi_sweep(mo_obj_val, ref_point):
    ...
    # P the derivative is all positive
    # U only one side derivative
    # Z deritive = 0
...
if __name__ == '__main__':
    ...
    w = grad_multi_sweep_with_duplicate_handling(mo_obj_val, np.array([3,3]))
    res = compute_subsets(mo_obj_val, ref_point)
